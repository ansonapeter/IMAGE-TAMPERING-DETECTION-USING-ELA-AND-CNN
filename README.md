...
This project implements an advanced **image forensics system** that detects tampered and manipulated images using a combination of **Error Level Analysis (ELA)** and **Convolutional Neural Networks (CNN)**. It leverages the CASSIA v2 dataset to achieve high-accuracy detection of image forgeries across various manipulation techniques.# Image Tampering Detection using ELA and CNN
